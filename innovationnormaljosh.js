 ...
 * -----
 *
 * innovationnormaljosh.js
 *
 * InnovationNormaljosh user interface script
 * 
...
define([
    ...
    function (dojo, declare) {
        return declare("bgagame.innovationnormaljosh", ebg.core.gamegui, {
            constructor: function () {
                console.log('innovationnormaljosh constructor');
            ...
            debug_draw: function () {
                ...
                self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/debug_draw.html",
                    {
                        lock: true,
            ...
            */
            ...
            action_clicForInitialMeld: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/initialMeld.html",
                    {
                        lock: true,
                        card_id: card_id
                    },
            ...
            action_clickForUpdatedInitialMeld: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/updateInitialMeld.html",
                    {
                        lock: true,
                        card_id: card_id
                    },
            ...
            action_clicForAchieve: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/achieve.html",
                    {
                        lock: true,
                        age: age
                    },
            ...
            action_clicForDraw: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/draw.html",
                    {
                        lock: true,
                    },
                    this, function (result) { }, function (is_error) { if (is_error) self.resurrectClickEvents(true) }
            ...
            action_clicForMeld: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/meld.html",
                    {
                        lock: true,
                        card_id: card_id
                    },
            ...
            action_clicForDogma: function (event) {
                ...
                var ajax_call = function () {
                    ...
                    var selfie = self;
                    self.ajaxcall("/innovationnormaljosh/innovationnormaljosh/dogma.html",
                        {
                            lock: true,
            ...
            action_clicForChoose: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/choose.html",
                    {
                        lock: true,
                        card_id: card_id
                    },
            ...
            action_clicForChooseRecto: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/chooseRecto.html",
                    {
                        lock: true,
                        owner: owner,
                        location: location,
            ...
            action_clicForChooseSpecialOption: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/chooseSpecialOption.html",
                    {
                        lock: true,
                        choice: choice
                    },
            ...
            action_publicationClicForRearrange: function (event) {
                ...
                var self = this;
                this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/publicationRearrange.html",
                    {
                        lock: true,
            ...
            toggle_displayMode: function () {
                ...
                if (!this.isSpectator) {
                    ...
                    this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/updateDisplayMode.html",
                        {
                            lock: true,
            ...
            toggle_view: function () {
                ...
                if (!this.isSpectator) {
                    // Inform the server of this change to make it by default if the player refreshes the page
                    this.ajaxcall("/innovationnormaljosh/innovationnormaljosh/updateViewFull.html",
                        {
                            lock: true,
            ...
            /*
                ...
                Note: game notification names correspond to "notifyAllPlayers" and "notifyPlayer" calls in
                      your innovationnormaljosh.game.php file.
