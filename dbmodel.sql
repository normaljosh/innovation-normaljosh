...
ALTER TABLE `player` ADD `player_innovationnormaljosh_score` SMALLINT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'InnovationNormaljosh score (player_score is used for achievements in normal play)';
