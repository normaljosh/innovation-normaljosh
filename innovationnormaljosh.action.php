 ...
 * -----
 * 
 * innovationnormaljosh.action.php
 *
 * InnovationNormaljosh main action entry point
 *
 *
 ...
 * this.ajaxcall( "/innovationnormaljosh/innovationnormaljosh/myAction.html", ...)
 *
 */
  
  
  class action_innovationnormaljosh extends APP_GameAction
  { 
    // Constructor: please do not modify
       public function __default()
      {
          ...
          {
            $this->view = "innovationnormaljosh_innovationnormaljosh";
