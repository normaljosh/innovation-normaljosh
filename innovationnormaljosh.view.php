 ...
 * particular, you can set here the values of variables elements defined in innovationnormaljosh_innovationnormaljosh.tpl (elements
 ...
 */
  ...
  class view_innovationnormaljosh_innovationnormaljosh extends game_view
  {
    ...
    $hex = str_replace("#", "", $hex);
      ...
      {        
        ...
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "pile" );
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "player" );
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "deck_1_5" );
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "deck_6_10" );
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "decks" );
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "available_achievements" );
        $this->page->begin_block( "innovationnormaljosh_innovationnormaljosh", "special_achievements" );
